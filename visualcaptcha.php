...
function visualcaptcha_do_filter( $arg1, $arg2 = null, $arg3 = null ) {
    ...
    if ( $frontendData ) {
        ...
        if ( ( isset($_POST[ $frontendData[ 'imageFieldName' ] ] ) && $imageAnswer = $_POST[ $frontendData[ 'imageFieldName' ] ] ) && !empty( $imageAnswer ) ) {
            if ( $captcha->validateImage( $imageAnswer ) ) {
                $captchaValid = true;
            }
        } else if ( ( isset($_POST[ $frontendData[ 'audioFieldName' ] ] ) && $audioAnswer = $_POST[ $frontendData[ 'audioFieldName' ] ] ) && !empty( $audioAnswer ) ) {
